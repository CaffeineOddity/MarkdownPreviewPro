"""Settings helpers for MarkdownPreviewPro."""
import os

import sublime

_SETTINGS_FILE = "MarkdownPreviewPro.sublime-settings"
_DEFAULT_OUT = os.path.expanduser("~/Downloads/MarkdownPreviewPro")
...
def output_dir():
    ...
    if not raw:
        ...
        try:
            ...
            path = os.path.join(base, "MarkdownPreviewPro")
        except Exception:
            path = _DEFAULT_OUT
    else:
