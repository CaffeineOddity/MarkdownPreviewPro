...
def render_tex_batch(jobs):
    ...
    try:
        ...
        if r.returncode != 0:
            ...
            print("[MarkdownPreviewPro] katex SSR node failed: %s" % err)
            return None
        out = json.loads(r.stdout or "[]")
    except Exception as e:
        print("[MarkdownPreviewPro] katex SSR exception: %s" % e)
        return None
