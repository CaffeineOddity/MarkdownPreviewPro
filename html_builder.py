...
def build_export_html(
    ...
    return (
        ...
        ".mdpp-wrap{display:block!important;padding:0!important} "
        ...
        ".markdown-body pre,.markdown-body code,.markdown-body .codehilite{background:#f8f8f8!important;border:1px solid #ddd;white-space:pre-wrap!important;word-wrap:break-word!important} "
        ".markdown-body pre,.markdown-body .codehilite{page-break-inside:avoid;box-shadow:none!important} "
        ".markdown-body table{page-break-inside:avoid;box-shadow:none!important} "
        ".markdown-body img,.markdown-body svg{max-width:100%!important;page-break-inside:avoid} "
